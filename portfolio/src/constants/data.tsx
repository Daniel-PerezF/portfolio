...
export const projects = [
  ...
  },
  {
    ...
    key: "portfolio",
    mainImg: "./project-images/portfolio-home-mac.png",
    imgs: [
      "./project-images/portfolio-home-mac.png",
      "./project-images/portfolio-home-2-mac.png",
      "./project-images/portfolio-message-mac.png",
      "./project-images/portfolio-message-2-mac.png",
      "./project-images/portfolio-links-mac.png",
      "./project-images/portfolio-about-mac.png",
      "./project-images/portfolio-experience-mac.png",
      "./project-images/portfolio-projects-mac.png",
      "./project-images/portfolio-projects-2-mac.png",
      "./project-images/portfolio-tech-mac.png",
    ],
    mobileImgs: [
      "./project-images/portfolio-home.png",
      "./project-images/portfolio-home-mobile.png",
      "./project-images/portfolio-links-mobile.png",
      "./project-images/portfolio-message-mobile.png",
      "./project-images/portfolio-message-2-mobile.png",
      "./project-images/portfolio-about-mobile.png",
      "./project-images/portfolio-experience-mobile.png",
      "./project-images/portfolio-projects-mobile.png",
      "./project-images/portfolio-projects-2-mobile.png",
      "./project-images/portfolio-tech-mobile.png",
    ],
    features: [
      {
        ft: "Creative Design",
        desc: "Utilized creativity in designing a portfolio website in the style of a Twitter/X account, aiming for a visually engaging and fun user experience.",
      },
      {
      ...
      },
      {
        ...
        desc: "Showcase projects with both mobile and desktop views to highlight the responsiveness. Ensure a seamless user experience across various devices.",
      },
      {
        ft: "Session Storage",
        desc: "Utilized session storage to store and retrieve user theme preferences and messages, ensuring a personalized experience that persists during the current browsing session.",
      },
    ],
    live: "https://dxniel.dev",
    github: "https://github.com/Daniel-PerezF/portfolioX",
    about:
