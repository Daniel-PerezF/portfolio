...
export const projects = [
  ...
  //       desc: "Utilized local storage to persistently store and retrieve user theme preference, ensuring a personalized experience that persists between sessions.",
  //     },
  //   ],
