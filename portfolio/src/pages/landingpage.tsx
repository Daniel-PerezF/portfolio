    ...
    <div className="h-screen">
      ...
      <div className="flex justify-center items-center flex-col">
        ...
        <div className="flex justify-between w-[75%] pt-8 lg:justify-around lg:px-40 lg:w-1/2 md:w-4/12 sm:w-2/5">
          <button className="px-1 py-1 rounded-xl text-[0.9rem] font-medium text-slate-800 bg-[#FBA337] hover:outline hover:outline-2 hover:outline-white">
            Contact Me
          </button>
          <button
            onClick={openResume}
            className="p-4 rounded-xl text-[0.9rem] text-slate-800 font-medium bg-[#FBA337] hover:outline hover:outline-2 hover:outline-white "
          >
            Resume
          </button>
        </div>
